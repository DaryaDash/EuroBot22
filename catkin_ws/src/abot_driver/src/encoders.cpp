...
EncodersPair::EncodersPair(double update_rate) :
	_encoder_left(17, 27, &EncoderWiringPiISR::encoderISR1, &EncoderWiringPiISR::encoderPosition1),
    _encoder_back(2, 1, &EncoderWiringPiISR::encoderISR3, &EncoderWiringPiISR::encoderPosition3),
	_encoder_right(24, 25, &EncoderWiringPiISR::encoderISR2, &EncoderWiringPiISR::encoderPosition2) {
